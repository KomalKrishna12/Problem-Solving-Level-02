import java.io.*;
// we have given n*n chess board, we have to place n knights so no knights can kill other
// satranj mai ghoda dhai kadam chlta hai
// so we have to check all 4 prev possitions bcoz in combination no arrangements are possible so 
// we check all prev 4 position
public class Q37_nknights_combination_2d_as_1d_knight_chooses{
