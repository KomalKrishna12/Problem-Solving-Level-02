import java.util.*;
public class Q19_Top_view_of_binary_tree {
    ...
    // this is the same problem like bottom view of binary tree
    // when we create array list add null for all index
    // when the particular index contains null then only add node.val because we want top view 
    // so we don't update it's value with repect to level order
