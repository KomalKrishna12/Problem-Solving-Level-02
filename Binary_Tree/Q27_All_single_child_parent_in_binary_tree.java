import java.util.*;
public class Q27_All_single_child_parent_in_binary_tree {
  ...
  public static void exactlyOneChild(TreeNode root, ArrayList<Integer> ans) {
      ...
      // if root is leaf then also return
      // else if any one child right or left is null then add that root into ans arraylist
      // call for next left and right
    if(root == null) return;
