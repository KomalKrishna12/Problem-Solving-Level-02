...
public class Q22_Articulation_Point {
    ...
    public static void dfs(int src, ArrayList<ArrayList<Integer>> graph) {
        ...
        for (int nbr : nbrs) {
            ...
            // if nbr uis visited then store current low as min of curent low and disc of
            // nbr
                ...
                if (parent[src] == -1) {
                    // for actual src this articulation condition will not work so using count we
                    // can
                    // find out
                    // if count is 1 and all vertex is visited that means it is not articulation
                    // point
